...
// Amounts in PHP (numeric only; display via formatCurrency)
...
export const mockProspects = [
  ...
  },
  {
    ...
    role: "Single",
    householdId: "ph3",
    householdName: "Santos",
    email: "clara.s@email.com",
    phone: "(555) 103-4567",
    age: 29,
    joinDate: "2024-09-15",
    status: "Prospect",

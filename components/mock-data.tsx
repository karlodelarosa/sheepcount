...
export const mockHouseholds = [
  ...
  },
  {
    id: "h7",
    name: "Thompson",
    address: "246 Ash Street, Springfield, IL 62707",
    createdDate: "2024-09-10",
  },
  {
    id: "h8",
    name: "Green",
    address: "135 Willow Road, Springfield, IL 62708",
    createdDate: "2024-08-15",
  },
  {
    id: "h9",
    name: "Rivera",
    address: "579 Oakwood Lane, Springfield, IL 62709",
    createdDate: "2024-10-13",
  },
  {
    id: "h10",
    name: "Kim",
    address: "864 Maplewood Street, Springfield, IL 62710",
...
export const mockMinistries = [
  ...
  {
    id: "m2",
    name: "Children's Teachers",
    description: "Sunday school and children's programs",
    color: "blue",
  },
  {
    id: "m3",
    name: "Youth Ministry Pastor and Leaders",
    description: "Teen ministry leadership",
    color: "green",
  },
  {
    id: "m4",
    name: "Hospitality",
    description: "Greeting and welcoming visitors",
    color: "orange",
  },
  {
    id: "m5",
...
export const mockAdminPositions = [
  ...
  {
    id: "ap8",
    title: "Christian Education Head",
    personId: "1",
    appointedDate: "2023-01-20",
    term: "2023-2025",
  },
...
export const mockChurchGoals = {
  yearlyGoal: {
    ...
    vision:
      "To establish a Christ-centered community that transforms lives through worship, discipleship, and outreach. Our goal is to grow deeper in faith, broader in fellowship, and stronger in service.",
    objectives: [
  ...
  monthlyThemes: [
    ...
    },
    {
      month: 8,
      name: "August",
      theme: "Spiritual Gifts and Service",
...
export const mockLifeGroups = [
  {
    ...
    description: "Bible lessons for ages 5-12",
    category: "Children",
    color: "blue",
  },
  {
    id: "lg2",
    name: "Kids Programs",
    description: "Special activities and events for children",
    category: "Children",
    color: "blue",
  },
  {
    id: "lg3",
    name: "Youth Service",
    description: "Teen worship and fellowship",
    category: "Youth",
    color: "green",
  },
  {
    ...
    description: "Career-age adults fellowship",
    category: "Adults",
    color: "purple",
  },
  {
...
export const mockFinancialExpenses = [
  ...
  },
  {
    ...
    amount: 850,
    description: "Children's ministry materials",
    vendor: "Christian Bookstore",
  },
  {
    id: "fe5",
    date: "2024-10-01",
    category: "Missions Support",
    amount: 5000,
    description: "Monthly missionary support",
    vendor: "Mission Partners",
  },
  {
    id: "fe6",
    date: "2024-09-28",
  ...
  },
  {
    ...
    category: "Technology",
    amount: 1500,
    description: "Sound system upgrades",
  ...
  },
  {
    ...
    category: "Youth Ministry",
    amount: 1200,
    description: "Youth retreat expenses",
    vendor: "Camp Facilities",
  },
];
...
export const mockGoalProjects = [
  {
    ...
    description:
      "Complete renovation of main sanctuary including new seating, sound system, and lighting",
    goalAmount: 1000000,
    raisedAmount: 675000,
...
export const mockPrograms = [
  {
    ...
    description:
      "Week-long program for children with Bible stories, crafts, and activities",
    type: "Event",
...
export const mockServiceTypes = [
  ...
  },
  {
    id: "st2",
    name: "Sunday School",
    description: "Bible study and classes",
    color: "green",
  },
  {
    id: "st3",
    name: "Men's Fellowship",
    description: "Men's gathering and discipleship",
    color: "indigo",
  },
  {
    id: "st4",
    name: "Ladies' Fellowship",
    description: "Women's meeting and fellowship",
    color: "pink",
  },
  {
    id: "st5",
    name: "Young Professionals Fellowship",
    description: "YP fellowship and networking",
    color: "purple",
  },
  {
    id: "st6",

  ...
  const groupedByCategory = useMemo(
    () =>
      lifeGroups.reduce(
        ...
        {} as Record<string, typeof lifeGroups>,
      ),
    [lifeGroups],
  );

  const categoryOrder = ["Children", "Youth", "Adults"];
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription className="text-slate-600 dark:text-zinc-400">
                Fellowship groups organized by life stage
              </CardDescription>
            </div>
            <Button

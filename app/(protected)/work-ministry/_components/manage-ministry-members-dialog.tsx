...
export function ManageMinistryMembersDialog({ open, onOpenChange, ministryId }: ManageMinistryMembersDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      <DialogContent className="sm:max-w-[700px] bg-white border-slate-200/60 dark:bg-zinc-800 dark:border-zinc-700/60 dark:text-white">
        <DialogHeader>
          <DialogTitle className="text-slate-900 dark:text-white">Manage Ministry Members</DialogTitle>
          <DialogDescription className="text-slate-600 dark:text-zinc-400">
            {ministry ? `Managing members for ${ministry.name}` : "Manage ministry team members"}
          </DialogDescription>
        </DialogHeader>

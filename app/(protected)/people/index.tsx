...
export function PeopleList() {
  ...
  const households = filteredPeople.reduce((acc, person) => {
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>Manage members and their household information</CardDescription>
            </div>
                  ...
                  filteredPeople.map((person) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell>
                          <Badge variant={person.role === "Head" ? "default" : "secondary"} className="rounded-lg">
                            {person.role}
                          </Badge>
                        </TableCell>
                        <TableCell>
                        ...
                        <TableCell className="text-slate-600">{person.email || person.phone || "N/A"}</TableCell>
                        <TableCell>
                          <Button 
                            variant="ghost" 
                            size="sm"

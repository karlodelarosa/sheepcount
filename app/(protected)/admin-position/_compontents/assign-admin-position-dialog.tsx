...
export function AssignAdminPositionDialog({ open, onOpenChange }: AssignAdminPositionDialogProps) {
  ...
  const DualModeOutlineButtonClass = "rounded-lg border-slate-200 text-slate-700 hover:bg-slate-100 dark:border-zinc-700 dark:text-white dark:hover:bg-zinc-700";
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      <DialogContent className="sm:max-w-[500px] bg-white border-slate-200/60 dark:bg-zinc-800 dark:border-zinc-700/60 dark:text-white">
        <DialogHeader>
          <DialogTitle className="text-slate-900 dark:text-white">Assign Administrative Position</DialogTitle>
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid gap-4 py-4">
            <div className="space-y-2">
              <Label htmlFor="position-title" className="text-slate-700 dark:text-zinc-300">Position</Label>
            ...
            <div className="space-y-2">
              <Label htmlFor="term" className="text-slate-700 dark:text-zinc-300">Term (e.g., 2025-2027)</Label>
              <Input
                id="term"
          ...
          <DialogFooter>
            <Button type="button" variant="outline" onClick={() => onOpenChange(false)} className={DualModeOutlineButtonClass}>
              Cancel
            </Button>
